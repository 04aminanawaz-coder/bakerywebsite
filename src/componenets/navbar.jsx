...
const animateText = (text) =>
  ...
  return (
    <>
<div className="w-full h-20  bg-[#f8f0cc] border-b-4 border-red-700 flex justify-between fixed top-0 left-0 z-50">
 <div className="box1  w-50 h-full flex justify-center items-center gap-2 ">

 <img className="w-12 h-12 "  src="./images/Rabia3.png" alt="" />
 <p p className="font1 text-xl   font-bold ">Rabia's Kitchen</p>
 </div>
{/*-------------------------------Navbar-------------------------------*/}
